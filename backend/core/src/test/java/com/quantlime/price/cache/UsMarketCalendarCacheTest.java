...
class UsMarketCalendarCacheTest {
    ...
    void isMarketOpenNow_allDaysHaveNoRegularMarket_returnsFalse() {
        ...
        // when
        boolean result = usMarketCalendarCache.isMarketOpenNow();
    ...
    void isMarketOpenNow_calledTwiceSameDay_fetchesCalendarOnlyOnce() {
        ...
        // when
        usMarketCalendarCache.isMarketOpenNow();
        usMarketCalendarCache.isMarketOpenNow();
    ...
    void isMarketOpenNow_calendarCallThrows_doesNotRetryEveryTickDuringBackoff() {
        ...
        // when
        boolean firstCall = usMarketCalendarCache.isMarketOpenNow();
        boolean secondCall = usMarketCalendarCache.isMarketOpenNow();

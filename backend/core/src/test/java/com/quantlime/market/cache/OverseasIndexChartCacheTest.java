...
class OverseasIndexChartCacheTest {
    ...
    void get_parsesOffsetDateTimeAndSortsByTradeDateAscending() {
        ...
        // when
        List<IndexChartResponse> result = overseasIndexChartCache.get(".IXIC", false);
    ...
    void get_withinTtl_doesNotRefetch() {
        ...
        // when
        overseasIndexChartCache.get(".IXIC", false);
        overseasIndexChartCache.get(".IXIC", false);
    ...
    void get_differentCodes_cachedIndependently() {
        ...
        // when
        List<IndexChartResponse> nasdaq = overseasIndexChartCache.get(".IXIC", false);
        List<IndexChartResponse> soxx = overseasIndexChartCache.get("SOXX.O", true);
    ...
    void get_etfCode_usesWorldStockPricesInsteadOfIndex() {
        ...
        // when
        overseasIndexChartCache.get("SOXX.O", true);
    ...
    void get_afterTtlExpired_refetches() {
        ...
        Map<String, Object> cacheByCode =
            (Map<String, Object>) ReflectionTestUtils.getField(overseasIndexChartCache, "cacheByCode");
        cacheByCode.clear();
        overseasIndexChartCache.get(".IXIC", false);

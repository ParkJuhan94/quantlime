...
class DomesticIndexMinuteChartCacheTest {
    ...
    void get_parsesAndSortsByTimeAscending() {
        ...
        // when
        List<IndexMinuteChartResponse> result = domesticIndexMinuteChartCache.get("KOSPI");
    ...
    void get_withinTtl_doesNotRefetch() {
        ...
        // when
        domesticIndexMinuteChartCache.get("KOSPI");
        domesticIndexMinuteChartCache.get("KOSPI");
    ...
    void get_differentCodes_cachedIndependently() {
        ...
        // when
        List<IndexMinuteChartResponse> kospi = domesticIndexMinuteChartCache.get("KOSPI");
        List<IndexMinuteChartResponse> kosdaq = domesticIndexMinuteChartCache.get("KOSDAQ");
    ...
    void get_afterTtlExpired_refetches() {
        ...
        Map<String, Object> cacheByCode =
            (Map<String, Object>) ReflectionTestUtils.getField(domesticIndexMinuteChartCache, "cacheByCode");
        cacheByCode.clear();
        domesticIndexMinuteChartCache.get("KOSPI");
